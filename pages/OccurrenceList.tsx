...
export const OccurrenceList: React.FC<OccurrenceListProps> = ({ deliveries, routes, drivers }) => {
                    ...
                    <tr key={occ.id} className="hover:bg-slate-50 group">
                        ...
                        <td className="p-4 text-center">
                            <span className={`px-2 py-1 rounded-full text-xs font-bold ${
                                occ.status === 'RETURNED' ? 'bg-orange-100 text-orange-700' : 'bg-red-100 text-red-700'
                            }`}>
