  ...
  const menuItems = [
    {
      ...
      label: 'Geral',
      icon: Building,
      description: 'Dados da empresa e plano',
    },
    {
      id: 'USERS',
    ...
    },
    {
      ...
      icon: MessageSquare,
      description: 'Bot e mensagens automáticas',
    },
    {
      id: 'OPERATION',
      label: 'Operação',
      icon: Shield,
      description: 'Regras, workflows e jornada',
    },
  ];
    ...
    <div className="flex h-[calc(100vh-64px)] bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto p-8">
        <div className="max-w-4xl mx-auto">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-800 flex items-center gap-3">
                {menuItems.find((i) => i.id === activeSection)?.icon &&
                  React.createElement(
                    menuItems.find((i) => i.id === activeSection)!.icon,
                    { size: 32, className: 'text-slate-400' },
                  )}
          ...
          {notification && (
            <div
              className={`mb-8 p-4 rounded-xl border flex items-center gap-3 shadow-sm animate-in fade-in slide-in-from-top-4 ${
