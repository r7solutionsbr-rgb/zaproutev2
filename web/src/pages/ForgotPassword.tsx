  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden p-8">
        <Link
          to="/login"
          className="flex items-center gap-2 text-slate-500 hover:text-blue-600 mb-6 text-sm font-bold transition-colors"
        >
        ...
        {status === 'SUCCESS' ? (
          <div className="bg-green-50 border border-green-100 rounded-xl p-6 text-center animate-in fade-in zoom-in">
            ...
            <Link
              to="/login"
              className="block mt-6 w-full py-3 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition-colors"
            >
              Voltar ao Login
            </Link>
          </div>
