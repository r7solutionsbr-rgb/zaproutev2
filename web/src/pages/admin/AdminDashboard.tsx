...
export const AdminDashboard: React.FC<{ onLogout: () => void }> = ({
  onLogout,
}) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col gap-2">
            ...
            <div className="text-xs text-slate-400">
              {((activeTenants / (totalTenants || 1)) * 100).toFixed(0)}% da
              base
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col gap-2">
            ...
            <div className="text-xs text-slate-400">
              Média de {(totalUsers / (totalTenants || 1)).toFixed(1)} por
              empresa
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col gap-2">
            ...
            <div className="text-3xl font-bold text-green-600">
              R$ {calculateMRR().toLocaleString('pt-BR')}
            </div>
            <div className="text-xs text-slate-400">
                ...
                <tbody className="divide-y divide-slate-100">
                  {filteredTenants.map((tenant) => (
                    ...
                    >
                      ...
                      <td className="p-4">
                        <span
                          className={`px-2.5 py-1 rounded-full text-xs font-bold flex w-fit items-center gap-1.5 ${
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Ex: Logística Rápida"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">
                    ...
                    <input
                      ...
                      placeholder="ex: logistica-rapida"
                    />
                  </div>
                </div>
                ...
                <div className="flex justify-end gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="px-6 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-bold shadow-lg shadow-blue-600/20 flex items-center gap-2 transition-all transform hover:scale-105 active:scale-95 disabled:opacity-70 disabled:scale-100"
                  >
                    {submitting ? (
